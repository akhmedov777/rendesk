import { AppIcon } from "@rendesk/ui/app-icon"
...
import { Keybind } from "@rendesk/ui/keybind"
import { Popover } from "@rendesk/ui/popover"
import { Spinner } from "@rendesk/ui/spinner"
...
const MAC_APPS = [
  {
    ...
    label: "Excel",
    icon: "excel",
    openWith: "Microsoft Excel",
  },
  {
    id: "word",
    label: "Word",
    icon: "word",
    openWith: "Microsoft Word",
  },
  {
    id: "powerpoint",
    label: "PowerPoint",
    icon: "powerpoint",
    openWith: "Microsoft PowerPoint",
  },
  {
    id: "adobe-acrobat",
    label: "Adobe Acrobat",
    icon: "adobe-acrobat",
    openWith: "Adobe Acrobat",
  },
  { id: "preview", label: "Preview", icon: "preview", openWith: "Preview" },
] as const
...
const OPEN_ICON_BASE = new Set<OpenIcon>([
  "finder",
  "file-explorer",
  "excel",
  "word",
                  ...
                  >
                    ...
                    >
                      <div class="relative flex items-center justify-center size-4 [&>*]:absolute [&>*]:inset-0">
                        <Icon
                          size="small"
                          name={view().reviewPanel.opened() ? "layout-left-partial" : "layout-left"}
                        ...
                        <Icon
                          size="small"
                          name={view().reviewPanel.opened() ? "layout-left" : "layout-left-partial"}
