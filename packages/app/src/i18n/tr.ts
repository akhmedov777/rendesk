...
export const dict = {
  ...
  "dialog.provider.opencode.note": "Renvel AI, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Rendesk tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Rendesk'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Rendesk Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  "provider.connect.opencodeZen.line2":
    "Tek bir API anahtarıyla Renvel AI, GPT, Gemini, GLM ve daha fazlası gibi modellere erişebilirsiniz.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Rendesk'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Rendesk'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler rendesk.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Rendesk sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Rendesk'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Rendesk ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (rendesk.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Rendesk henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "session.review.noVcs": "İnceleme bu çalışma alanında kullanılamıyor",
  ...
  "sidebar.gettingStarted.line1": "Rendesk ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Rendesk Masaüstü",
  ...
  "settings.desktop.wsl.description": "Rendesk sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Rendesk'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Rendesk'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Rendesk'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Rendesk başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Rendesk'un en son sürümünü kullanıyorsunuz.",
