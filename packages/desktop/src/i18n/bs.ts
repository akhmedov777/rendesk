export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Rendesk-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Rendesk-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'rendesk'.",
  ...
  "desktop.menu.help.documentation": "Rendesk Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka Rendesk CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
