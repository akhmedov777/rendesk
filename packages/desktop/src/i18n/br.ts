export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Rendesk",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Rendesk foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do Rendesk",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do Rendesk está ausente. Tente reinstalar o aplicativo de desktop.",
