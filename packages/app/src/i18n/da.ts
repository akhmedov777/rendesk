export const dict = {
  ...
  "dialog.provider.opencode.note": "Udvalgte modeller inklusive Renvel AI, GPT, Gemini og flere",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Rendesk",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Rendesk.",
  ...
  "provider.connect.opencodeZen.line1":
    "Rendesk Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.opencodeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Renvel AI, GPT, Gemini, GLM og flere.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Rendesk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Rendesk.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i rendesk.json",
  ...
  "dialog.server.description": "Skift hvilken Rendesk-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Rendesk ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Rendesk-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (rendesk.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Rendesk understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Rendesk inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Rendesk-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Rendesk",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Rendesk ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Rendesk er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Rendesk starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Rendesk.",
