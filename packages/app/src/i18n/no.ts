...
export const dict = {
  ...
  "dialog.provider.opencode.note": "Utvalgte modeller inkludert Renvel AI, GPT, Gemini og mer",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Rendesk",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Rendesk.",
  ...
  "provider.connect.opencodeZen.line1":
    "Rendesk Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.opencodeZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Renvel AI, GPT, Gemini, GLM og flere.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Rendesk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Rendesk.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i rendesk.json",
  ...
  "dialog.server.description": "Bytt hvilken Rendesk-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Rendesk ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Rendesk-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (rendesk.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Rendesk ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Rendesk inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Rendesk-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Rendesk",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Rendesk ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Rendesk er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Rendesk starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Rendesk.",
