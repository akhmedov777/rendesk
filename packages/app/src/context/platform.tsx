...
export type Platform = {
  ...
  /** Feature gating exposed by the runtime */
  capabilities?: {
    dashboard?: boolean
  ...
  /** Local desktop sidecar service URL (desktop only) */
  serviceUrl?: string
  ...
  /** Active document editor state (desktop only) */
  activeEditorContext?: Accessor<ActiveEditorContext | null>
}
