export const dict = {
  ...
  "dialog.provider.opencode.note": "Curated models including Renvel AI, GPT, Gemini and more",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Rendesk",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Rendesk.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Rendesk Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Renvel AI, GPT, Gemini, GLM and more.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Rendesk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Rendesk.",
  ...
  "prompt.example.1": "Show me total sales for this month",
  "prompt.example.2": "Which customers owe us the most money?",
  "prompt.example.3": "List our top 10 best-selling products",
  "prompt.example.4": "What's the current inventory in each warehouse?",
  "prompt.example.5": "Show production output for this week",
  "prompt.example.6": "Find suppliers with outstanding invoices",
  "prompt.example.7": "How much raw milk did we receive this month?",
  "prompt.example.8": "Show today's cash flow — receipts and expenses",
  "prompt.example.9": "Summarize the key points from this document",
  "prompt.example.10": "Create a formatted report from this spreadsheet",
  "prompt.example.11": "Compare figures between these two files",
  "prompt.example.12": "Extract totals and dates from this PDF invoice",
  "prompt.example.13": "Convert this price list into a clean table",
  "prompt.example.14": "Generate a daily sales report for management",
  "prompt.example.15": "Draft a monthly P&L summary",
  "prompt.example.16": "Build a dashboard of production KPIs",
  "prompt.example.17": "Create a purchase order from current stock levels",
  "prompt.example.18": "Reconcile bank payments with 1C records",
  "prompt.example.19": "Prepare a quarterly revenue breakdown by product",
  "prompt.example.20": "Set up a weekly counterparty balance report",
  "prompt.example.21": "Analyze our sales trends over the past 6 months",
  "prompt.example.22": "Which product categories are growing fastest?",
  "prompt.example.23": "Forecast next month's raw material needs",
  "prompt.example.24": "Help me write a business letter to a supplier",
  "prompt.example.25": "What was our most profitable week this quarter?",
  ...
  "dialog.plugins.empty": "Plugins configured in rendesk.json",
  ...
  "dialog.server.description": "Switch which Rendesk server this app connects to.",
  ...
  "toast.update.description": "A new version of Rendesk ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Rendesk team",
  ...
  "error.chain.checkConfig": "Check your config (rendesk.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Rendesk does not support MCP authentication yet.',
  ...
  "session.review.noVcs": "Review is unavailable for this workspace",
  ...
  "sidebar.gettingStarted.line1": "Rendesk includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Rendesk Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Rendesk server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Rendesk",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Rendesk looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Rendesk is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Rendesk launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Rendesk.",
