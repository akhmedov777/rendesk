export const dict = {
  ...
  "dialog.provider.opencode.note": "Modelos selecionados incluindo Renvel AI, GPT, Gemini e mais",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Rendesk",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Rendesk.",
  ...
  "provider.connect.opencodeZen.line1":
    "Rendesk Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.opencodeZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Renvel AI, GPT, Gemini, GLM e mais.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Rendesk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Rendesk.",
  ...
  "dialog.plugins.empty": "Plugins configurados em rendesk.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Rendesk este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Rendesk ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Rendesk",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (rendesk.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Rendesk ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Rendesk inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Rendesk dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Rendesk",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Rendesk aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Rendesk é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Rendesk iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Rendesk.",
