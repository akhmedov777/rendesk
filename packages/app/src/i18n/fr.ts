export const dict = {
  ...
  "dialog.provider.opencode.note": "Modèles sélectionnés incluant Renvel AI, GPT, Gemini et plus",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Rendesk",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Rendesk.",
  ...
  "provider.connect.opencodeZen.line1":
    "Rendesk Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  "provider.connect.opencodeZen.line2":
    "Avec une seule clé API, vous aurez accès à des modèles tels que Renvel AI, GPT, Gemini, GLM et plus encore.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Rendesk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Rendesk.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans rendesk.json",
  ...
  "dialog.server.description": "Changez le serveur Rendesk auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Rendesk ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Rendesk",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (rendesk.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Rendesk ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Rendesk inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Rendesk dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Rendesk",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Rendesk sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Rendesk.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Rendesk",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Rendesk.",
