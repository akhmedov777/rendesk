export const dict = {
  ...
  "dialog.provider.opencode.note": "Kurirani modeli uključujući Renvel AI, GPT, Gemini i druge",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Rendesk",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Rendesk-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Rendesk Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.opencodeZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Renvel AI, GPT, Gemini, GLM i drugi.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Rendesk-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Rendesk-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u rendesk.json",
  ...
  "dialog.server.description": "Promijeni na koji se Rendesk server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Rendesk-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Rendesk timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (rendesk.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Rendesk još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Rendesk uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Rendesk server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Rendesk-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Rendesk izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Rendesk-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Rendesk pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Rendesk-a.",
