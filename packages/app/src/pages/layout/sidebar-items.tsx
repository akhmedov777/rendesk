import type { Message, Session, TextPart, UserMessage } from "@rendesk/sdk/v2/client"
import { Avatar } from "@rendesk/ui/avatar"
import { HoverCard } from "@rendesk/ui/hover-card"
import { Icon } from "@rendesk/ui/icon"
import { IconButton } from "@rendesk/ui/icon-button"
import { MessageNav } from "@rendesk/ui/message-nav"
...
const RENDESK_PROJECT_ID = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
  ...
  return (
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={props.project.id === RENDESK_PROJECT_ID ? "/favicon.svg" : props.project.icon?.override}
