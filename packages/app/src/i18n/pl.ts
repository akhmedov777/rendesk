export const dict = {
  ...
  "dialog.provider.opencode.note": "Wyselekcjonowane modele, w tym Renvel AI, GPT, Gemini i inne",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Rendesk",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Rendesk.",
  ...
  "provider.connect.opencodeZen.line1":
    "Rendesk Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.opencodeZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Renvel AI, GPT, Gemini, GLM i więcej.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Rendesk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Rendesk.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w rendesk.json",
  ...
  "dialog.server.description": "Przełącz serwer Rendesk, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Rendesk ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Rendesk",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (rendesk.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Rendesk zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Rendesk",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Rendesk na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Rendesk.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Rendesk",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Rendesk.",
