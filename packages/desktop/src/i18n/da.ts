export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Rendesk",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Rendesk er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'rendesk'-kommandoen.",
  ...
  "desktop.cli.error.sidecarMissing": "Rendesk CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
