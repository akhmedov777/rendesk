export const dict = {
  ...
  "desktop.menu.help.documentation": "Rendesk Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of Rendesk",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Rendesk has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'rendesk' command.",
  ...
  "desktop.cli.error.sidecarMissing": "Rendesk CLI binary is missing. Try reinstalling the desktop app.",
