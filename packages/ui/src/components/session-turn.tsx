import { AssistantMessage, type FileDiff, Message as MessageType, Part as PartType } from "@rendesk/sdk/v2/client"
import type { SessionStatus } from "@rendesk/sdk/v2"
import { useData } from "../context"
import { useFileComponent } from "../context/file"

import { same } from "@rendesk/util/array"
import { Binary } from "@rendesk/util/binary"
import { getDirectory, getFilename } from "@rendesk/util/path"
...
export function SessionTurn(
  ...
  const showDiffSummary = createMemo(() => false)
