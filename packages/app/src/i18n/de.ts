...
export const dict = {
  ...
  "dialog.provider.opencode.note": "Kuratierte Modelle inklusive Renvel AI, GPT, Gemini und mehr",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Rendesk",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Rendesk zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "Rendesk Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.opencodeZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Renvel AI, GPT, Gemini, GLM und mehr.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Rendesk zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Rendesk zu nutzen.",
  ...
  "dialog.plugins.empty": "In rendesk.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Rendesk-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Rendesk ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Rendesk-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (rendesk.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Rendesk unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Rendesk enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  "sidebar.gettingStarted.line2":
    "Model access is managed by your organization. No provider connection is required.",
  ...
  "settings.desktop.wsl.description": "Rendesk-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Rendesk ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Rendesk auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Rendesk anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Rendesk automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Rendesk.",
