export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Rendesk",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Rendesk، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق Rendesk",
  ...
  "desktop.cli.error.sidecarMissing": "ملف Rendesk CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
