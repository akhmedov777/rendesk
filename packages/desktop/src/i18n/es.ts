export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Rendesk",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Rendesk. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de Rendesk",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de Rendesk. Intenta reinstalar la aplicación de escritorio.",
