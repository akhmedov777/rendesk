export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Rendesk",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Rendesk er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "Rendesk Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Rendesk CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
