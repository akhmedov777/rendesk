export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Rendesk を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Rendesk のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'rendesk' コマンドを使用してください。",
  ...
  "desktop.menu.help.documentation": "Rendesk ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "Rendesk CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
