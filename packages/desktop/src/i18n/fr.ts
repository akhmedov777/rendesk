export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Rendesk",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Rendesk a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'rendesk'.",
  ...
  "desktop.menu.help.documentation": "Documentation d'Rendesk",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI Rendesk est manquant. Essayez de réinstaller l'application de bureau.",
