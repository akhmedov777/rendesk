export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Rendesk",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Rendesk. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'rendesk'.",
  ...
  "desktop.menu.help.documentation": "Dokumentacja Rendesk",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego Rendesk CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
