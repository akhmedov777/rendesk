...
export function SessionSidePanel(props: {
  ...
  const reviewResizeMax = createMemo(() => {
    if (typeof window === "undefined") return 1000
    const minSidePanelWidth = (fileOpen() ? layout.fileTree.width() : 0) + minReviewWidth
    return Math.max(280, window.innerWidth - minSidePanelWidth)
  })
    ...
    <Show when={isDesktop()}>
      ...
      >
        ...
        <Show when={reviewOpen()}>
          <div class="absolute inset-y-0 right-0 w-0" onPointerDown={() => props.size.start()}>
            <ResizeHandle
              direction="horizontal"
              edge="start"
