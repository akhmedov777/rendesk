export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Rendesk",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Rendesk wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'rendesk' zu verwenden.",
  ...
  "desktop.menu.help.documentation": "Rendesk-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das Rendesk CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
