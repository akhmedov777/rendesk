export const dict = {
  ...
  "desktop.updater.none.message": "你已在使用最新版的 Rendesk",
  ...
  "desktop.menu.help.documentation": "Rendesk 文件",
  ...
  "desktop.cli.error.sidecarMissing": "Rendesk CLI 執行檔遺失。請嘗試重新安裝桌面應用程式。",
