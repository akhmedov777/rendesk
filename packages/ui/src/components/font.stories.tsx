...
const docs = `### Overview
Loads Rendesk typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>Rendesk Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>Rendesk Mono Sample</div>
    </div>
  ),
}
