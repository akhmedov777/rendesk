...
beforeAll(async () => {
  ...
  mock.module("@rendesk/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@rendesk/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@rendesk/ui/icon", () => ({ Icon: () => null }))
  mock.module("@rendesk/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
