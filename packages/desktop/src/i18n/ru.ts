export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию Rendesk",
  ...
  "desktop.updater.downloaded.prompt": "Версия Rendesk {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.cli.installed.message":
    "CLI установлен в {{path}}\n\nПерезапустите терминал, чтобы использовать команду 'rendesk'.",
  ...
  "desktop.menu.help.documentation": "Документация Rendesk",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл Rendesk CLI. Попробуйте переустановить настольное приложение.",
